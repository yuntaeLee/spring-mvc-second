...
public class ValidationItemControllerV2 {
    ...
    /**
     * BindingResult 파라미터 위치는 @ModelAttribute Item 다음에 와야 한다.
...
//    @PostMapping("/add")
    ...
    /**
     * @Validated = Validator 를 실행시키는 annotation
     * supports method 를 통해 Validator 를 선택하고, validate method 를 호출한다.
     */
    @PostMapping("/add")
